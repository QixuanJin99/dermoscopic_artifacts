...
modes = ["whole", "lesion", "background", "bbox"]
traps = ['ruler_25', 'ruler_50', 'ruler_75', 'ruler_100', 
...
for dataset_mode in modes:
    ...
    for trap in traps: 
        ...
        save_dir = f"/mnt/scratch-lids/scratch/qixuanj/chil2025/classifiers_trap/{dataset_mode}/{trap}"
        ...
        model.load_state_dict(torch.load(f"{save_dir}/resnet50_split_1.pth"))
